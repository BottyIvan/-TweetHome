...
public class TwitterLogin extends ActionBarActivity implements OnClickListener {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (TWITTER_CONSUMER_KEY.trim().length() == 0
            ...
            alert.showAlertDialog(TwitterLogin.this, "Twitter oAuth tokens",
        ...
        final CircularImageView circularImageView = (CircularImageView)findViewById(R.id.ImgUser);
        /**
        ...
        if (!isTwitterLoggedInAlready()) {
            ...
            // oAuth verifier
                ...
                try {
                    ...
                    Ion.with(this).load(image).asBitmap().setCallback(new FutureCallback<Bitmap>() {
                        @Override
